...
| EncryptionWrapper | Encrypt values before storing and decrypt on retrieval. | `EncryptionWrapper(key_value=memory_store, source_material="your-source-material", salt="your-salt")` |
