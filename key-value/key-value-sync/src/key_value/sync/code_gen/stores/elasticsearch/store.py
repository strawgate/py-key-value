...
class ElasticsearchStore(
    ...
    @overload
    def __init__(self, *, elasticsearch_client: Elasticsearch, index_prefix: str, default_collection: str | None = None) -> None: ...
    ...
    def _sanitize_index_name(self, collection: str) -> str:
        sanitized_collection = sanitize_string(
            value=collection, replacement_character="_", max_length=MAX_INDEX_LENGTH, allowed_characters=ALLOWED_INDEX_CHARACTERS
        )
