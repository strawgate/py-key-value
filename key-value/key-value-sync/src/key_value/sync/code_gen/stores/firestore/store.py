...
class FirestoreStore(BaseContextManagerStore, BaseStore):
    ...
    def __init__(
        ...
        *,
        ...
        if client:
            ...
            self._client = firestore.Client(credentials=self._credentials, project=self._project, database=self._database)
    ...
    @override
    def _put_managed_entry(self, *, key: str, managed_entry: ManagedEntry, collection: str | None = None) -> None:
