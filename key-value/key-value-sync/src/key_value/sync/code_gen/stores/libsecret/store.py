...
try:
    ...
    msg = "LibsecretStore requires py-key-value-sync[libsecret]"
...
class LibsecretStore(
    ...
    def _setup(self) -> None:
        ...
        self._connection, self._collection = _init_connection()
