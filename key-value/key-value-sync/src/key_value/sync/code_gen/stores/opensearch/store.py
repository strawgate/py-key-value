...
class OpenSearchStore(
    ...
    def _setup_collection(self, *, collection: str) -> None:
        ...
        try:
            _ = self._client.indices.create(index=index_name, body={"mappings": DEFAULT_MAPPING, "settings": {}})
    ...
    def _get_managed_entry(self, *, key: str, collection: str) -> ManagedEntry | None:
        ...
        try:
            opensearch_response = self._client.get(index=index_name, id=document_id)
        except Exception:
            return None
    ...
    def _get_managed_entries(self, *, collection: str, keys: Sequence[str]) -> list[ManagedEntry | None]:
        ...
        try:
            opensearch_response = self._client.mget(index=index_name, body={"docs": docs})
        except Exception:
    ...
    def _delete_managed_entry(self, *, key: str, collection: str) -> bool:
        ...
        try:
            opensearch_response = self._client.delete(index=index_name, id=document_id)
        except Exception:
            return False
    ...
    def _get_collection_keys(self, *, collection: str, limit: int | None = None) -> list[str]:
        ...
        try:
            result = self._client.search(
                ...
                body={"query": {"term": {"collection": collection}}, "_source": False, "fields": ["key"], "size": limit},
            )
        except Exception:
            return []
    ...
    def _get_collection_names(self, *, limit: int | None = None) -> list[str]:
        ...
        try:
            search_response = self._client.search(
                ...
                body={"aggs": {"collections": {"terms": {"field": "collection", "size": limit}}}, "size": 0},
            )
        except Exception:
            return []
    ...
    def _cull(self) -> None:
        ...
        _ = self._client.delete_by_query(index=f"{self._index_prefix}-*", body={"query": {"range": {"expires_at": {"lt": ms_epoch}}}})
