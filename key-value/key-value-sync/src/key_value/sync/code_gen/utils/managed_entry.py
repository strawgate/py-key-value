...
# from the original file 'managed_entry.py'
...
from key_value.sync.code_gen.utils.time_to_live import now, now_plus, try_parse_datetime_str
...
class ManagedEntry:
    ...
    def from_json(cls, json_str: str, includes_metadata: bool = True, ttl: float | None = None) -> Self:
        ...
        return cls(created_at=created_at, expires_at=expires_at, ttl=ttl, value=value)
