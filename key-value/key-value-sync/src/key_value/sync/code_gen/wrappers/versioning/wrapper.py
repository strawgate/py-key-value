...
class VersioningWrapper(BaseWrapper):
    ...
    def __init__(self, key_value: KeyValue, version: str | int) -> None:
    ...
    def put(self, key: str, value: Mapping[str, Any], *, collection: str | None = None, ttl: SupportsFloat | None = None) -> None:
        ...
        return self.key_value.put(key=key, value=wrapped_value, collection=collection, ttl=ttl)
    ...
    def put_many(
        ...
        return self.key_value.put_many(keys=keys, values=wrapped_values, collection=collection, ttl=ttl)
