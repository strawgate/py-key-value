...
# from the original file 'test_base_model.py'
...
class TestBaseModelAdapter:
    ...
    @pytest.fixture
    def user_adapter(self, store: MemoryStore) -> BaseModelAdapter[User]:
        return BaseModelAdapter[User](key_value=store, pydantic_model=User)

    @pytest.fixture
    def updated_user_adapter(self, store: MemoryStore) -> BaseModelAdapter[UpdatedUser]:
        return BaseModelAdapter[UpdatedUser](key_value=store, pydantic_model=UpdatedUser)

    @pytest.fixture
    def updated_user_adapter_raising(self, store: MemoryStore) -> BaseModelAdapter[UpdatedUser]:
        return BaseModelAdapter[UpdatedUser](key_value=store, pydantic_model=UpdatedUser, raise_on_validation_error=True)

    @pytest.fixture
    def product_adapter(self, store: MemoryStore) -> BaseModelAdapter[Product]:
        return BaseModelAdapter[Product](key_value=store, pydantic_model=Product)

    @pytest.fixture
    def product_list_adapter(self, store: MemoryStore) -> BaseModelAdapter[list[Product]]:
        return BaseModelAdapter[list[Product]](key_value=store, pydantic_model=list[Product])

    @pytest.fixture
    def order_adapter(self, store: MemoryStore) -> BaseModelAdapter[Order]:
        return BaseModelAdapter[Order](key_value=store, pydantic_model=Order)

    def test_simple_adapter(self, user_adapter: BaseModelAdapter[User]):
    ...
    def test_simple_adapter_with_default(self, user_adapter: BaseModelAdapter[User]):
    ...
    def test_simple_adapter_with_list(self, product_list_adapter: BaseModelAdapter[list[Product]]):
    ...
    def test_simple_adapter_with_validation_error_raise(
        ...
        with pytest.raises(DeserializationError):
            updated_user_adapter_raising.get(collection=TEST_COLLECTION, key=TEST_KEY)

    def test_complex_adapter(self, order_adapter: BaseModelAdapter[Order]):
    ...
    def test_complex_adapter_with_list(self, product_list_adapter: BaseModelAdapter[list[Product]], store: MemoryStore):
