...
class TestRedisStore(ContextManagerStoreTestMixin, BaseStoreTests):
    ...
    def test_redis_document_format(self, store: RedisStore, redis_client: Redis):
        """Test Redis store document format."""
        store.put(collection="test", key="document_format_test_1", value={"test_1": "value_1"})
        store.put(collection="test", key="document_format_test_2", value={"test_2": "value_2"}, ttl=10)

        raw_documents = redis_client.mget(keys=["test::document_format_test_1", "test::document_format_test_2"])
        ...
        raw_documents = redis_client.mget(keys=["test::document_format_test_3", "test::document_format_test_4"])
        ...
        store.put(collection="test", key="document_format_test", value={"test": "value"}, ttl=10)
        raw_document = redis_client.get(name="test::document_format_test")
