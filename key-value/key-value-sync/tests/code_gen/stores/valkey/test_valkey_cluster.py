...
@pytest.mark.skip(
    reason="Full cluster integration tests require a multi-node Valkey cluster setup. GlideClusterClient requires an actual cluster with CLUSTER SLOTS support. See test_valkey.py for standalone instance tests."
)
