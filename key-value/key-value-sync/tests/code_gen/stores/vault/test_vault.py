...
class TestVaultStore(BaseStoreTests):
    ...
    def setup_vault(self, request: pytest.FixtureRequest) -> Generator[None, None, None]:
        ...
        with docker_container(f'vault-test-{version}', f'hashicorp/vault:{version}', {str(VAULT_CONTAINER_PORT): VAULT_PORT}, environment={'VAULT_DEV_ROOT_TOKEN_ID': VAULT_TOKEN, 'VAULT_DEV_LISTEN_ADDRESS': '0.0.0.0:8200'}):
