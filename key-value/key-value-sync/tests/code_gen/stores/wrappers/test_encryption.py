...
class TestFernetEncryptionWrapper(BaseStoreTests):
    ...
    @override
    @pytest.fixture
    def store(self, memory_store: MemoryStore, fernet: Fernet) -> FernetEncryptionWrapper:
        return FernetEncryptionWrapper(key_value=memory_store, fernet=fernet)
    

    def test_encryption_encrypts_value(self, store: FernetEncryptionWrapper, memory_store: MemoryStore):
    ...
    def test_encryption_with_string_key(self, store: FernetEncryptionWrapper, memory_store: MemoryStore):
        ...
        round_trip_value = store.get(collection='test', key='test')
    ...
    def test_encryption_many_operations(self, store: FernetEncryptionWrapper, memory_store: MemoryStore):
        ...
        store.put_many(collection='test', keys=keys, values=values)
    ...
    def test_decryption_handles_unencrypted_data(self, store: FernetEncryptionWrapper, memory_store: MemoryStore):
    ...
    def test_decryption_handles_corrupted_data(self, store: FernetEncryptionWrapper, memory_store: MemoryStore):
    ...
    def test_decryption_ignores_corrupted_data(self, memory_store: MemoryStore, fernet: Fernet):
    ...
    def test_decryption_with_multi_fernet(self, memory_store: MemoryStore):
        ...
        original_value = {'test': 'value'}
        first_fernet_store.put(collection='test', key='test', value=original_value)
        assert first_fernet_store.get(collection='test', key='test') == original_value
        ...
        assert multi_fernet_store.get(collection='test', key='test') == original_value
    ...
    def test_decryption_with_wrong_key_raises_error(self, memory_store: MemoryStore):
        ...
        original_value = {'test': 'value'}
        store1.put(collection='test', key='test', value=original_value)
