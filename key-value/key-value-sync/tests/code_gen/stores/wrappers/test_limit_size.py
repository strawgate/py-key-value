...
class TestLimitSizeWrapper(BaseStoreTests):
    ...
    def test_put_within_limit(self, memory_store: MemoryStore):
        limit_size_store: LimitSizeWrapper = LimitSizeWrapper(key_value=memory_store, max_size=1024, raise_on_too_large=True, raise_on_too_small=False)
    ...
    def test_exact_size_limit(self, memory_store: MemoryStore):
        ...
        limit_size_store_under: LimitSizeWrapper = LimitSizeWrapper(key_value=memory_store, max_size=exact_size - 1, raise_on_too_large=True)
        with pytest.raises(EntryTooLargeError):
