...
class TestRoutingWrapper(BaseStoreTests):
    ...
    def test_routing_get_and_get_many(self, store_with_data: RoutingWrapper, memory_store: MemoryStore, second_store: MemoryStore, default_store: MemoryStore):
    ...
    def test_routing_delete(self, store_with_data: RoutingWrapper, memory_store: MemoryStore, second_store: MemoryStore, default_store: MemoryStore):
...
class TestCollectionRoutingWrapper(TestRoutingWrapper):
    ...
    def store(self, memory_store: MemoryStore, second_store: MemoryStore, default_store: MemoryStore) -> CollectionRoutingWrapper:
        return CollectionRoutingWrapper(collection_map={COLLECTION_ONE: memory_store, COLLECTION_TWO: second_store}, default_store=default_store)
