...
# from the original file 'test_managed_entry.py'
...
from key_value.sync.code_gen.utils.managed_entry import dump_to_json, load_from_json
from tests.code_gen.cases import DICTIONARY_TO_JSON_TEST_CASES, DICTIONARY_TO_JSON_TEST_CASES_NAMES

FIXED_DATETIME = datetime(2025, 1, 1, 0, 0, 0, tzinfo=timezone.utc)
FIXED_DATETIME_STRING = FIXED_DATETIME.isoformat()


@pytest.mark.parametrize(argnames=("obj", "expected"), argvalues=DICTIONARY_TO_JSON_TEST_CASES, ids=DICTIONARY_TO_JSON_TEST_CASES_NAMES)
