...
# from the original file 'test_sanitize.py'
# DO NOT CHANGE! Change the original file instead.
import pytest
from inline_snapshot import snapshot

from key_value.sync.code_gen.utils.sanitize import (
...
@pytest.mark.parametrize(argnames="hash_fragment_mode", argvalues=[ONLY_IF_CHANGED_HASH, NEVER_HASH])
@pytest.mark.parametrize(argnames="max_length", argvalues=[16, 32])
...
@pytest.mark.parametrize(argnames="hash_fragment_mode", argvalues=[ONLY_IF_CHANGED_HASH, ALWAYS_HASH])
