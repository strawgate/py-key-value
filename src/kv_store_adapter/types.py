...
@runtime_checkable
class EnumerateKeysProtocol(Protocol):
...
@runtime_checkable
class EnumerateCollectionsProtocol(Protocol):
...
@runtime_checkable
class DestroyStoreProtocol(Protocol):
...
@runtime_checkable
class DestroyCollectionProtocol(Protocol):
...
class KVStore(KeyValueProtocol, Protocol):
