...
class PassthroughCacheWrapper(BaseWrapper):
    ...
    def __init__(
        ...
        """
        self.store: KVStore = primary_store
        self.cache_store: KVStore = cache_store
    ...
    async def get_many(self, keys: Sequence[str], *, collection: str | None = None) -> list[dict[str, Any] | None]:
        ...
        for i, key in enumerate[str](iterable=keys):
        ...
        for i, key in enumerate[str](iterable=uncached_keys):
